...
## 7. Data Flow
- Request -> Gateway -> OPA -> Allow/Deny -> Response
...
|---|---|---|
| SEC-POL-001 | Precedence | OPA config |
...
## 10. Scalability
OPA runs as sidecar to avoid latency.

## 11. Reliability
| SLI | SLO | Alert Threshold | Escalation |
|---|---|---|---|
| Evaluation | 99.99% | < 99.95% | PagerDuty |

## 12. Performance
| Operation | P50 | P95 | P99 | Throughput |
|---|---|---|---|---|
| Eval | 1ms | 3ms | 10ms | 10000 |

## 13. Observability
```text
storyos_pol_evals_total 1000
```

## 14. Failure Handling
1. Alert triggers on evaluation failure.
2. Fallback to default deny.
...
|---|---|---|
| SEC | Security | OPA bundles |

## 18. Future Evolution
Move to WASM compiled policies.

## 19. Executive Summary
Policy architecture secures everything.

## Required Technical Artifacts
### PostgreSQL Schema
```sql
CREATE SCHEMA pol_data;
CREATE TABLE pol_data.config (
    id UUID,
    tenant_id UUID,
    val TEXT
);
