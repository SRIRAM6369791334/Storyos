...
## 10. Scalability
Prometheus uses Cortex/Thanos.

## 11. Reliability
| SLI | SLO | Alert Threshold | Escalation |
|---|---|---|---|
| Dash Uptime | 99.9% | < 99.0% | IT |

## 12. Performance
| Operation | P50 | P95 | P99 | Throughput |
|---|---|---|---|---|
| Query | 100ms | 300ms | 1s | 1000 |

## 13. Observability
```text
storyos_mon_queries_total 100
```

## 14. Failure Handling
1. Alert triggers on scrape failure.
...
## 16. Governance Rules
### MON-001
- Rule: All apps must export /metrics.
...
## 18. Future Evolution
Move to fully managed SaaS monitoring.

## 19. Executive Summary
Monitoring architecture ensures full visibility.

## Required Technical Artifacts
### PostgreSQL Schema
```sql
CREATE SCHEMA mon_data;
CREATE TABLE mon_data.config (
    id UUID,
    tenant_id UUID,
    val TEXT
);
